...
# Your objective is to discover the Top 5 most significant AI advancements, releases, or research discoveries from the past week (or past month if highly impactful).

# Guidelines:
# 1. Maintain an open, unbiased lens across the entire field — from novel architectures, agent paradigms, and training methods to compute breakthroughs, open models, multimodal systems, or unexpected scientific applitions.
# 2. Formulate your own natural search queries to uncover what is genuinely new and impactful.
# 3. Do not include calendar years or hardcoded dates in queries; the search tool enforces freshness automatically.
# 4. When you have identified at least 5 distinct candidates with canonical links, synthesize your findings.
# """
